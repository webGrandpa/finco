...
const WhyUs = () => {
  return (
    <div className='text-center pb-10 bg-[#1B365D0D] flex flex-col items-center gap-6 px-6 md:px-10 lg:px-16 xl:px-40'>
      <div className='max-w-[1440px] w-full mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row justify-between bg-white p-6 lg:p-10 rounded-lg shadow-md w-full gap-8 mt-8'>
          <div className='flex flex-col gap-5 justify-start text-start w-full lg:w-1/2'>
            <SectionHeaders
              ...
              textCenter='start'
            />
            <div className='flex flex-col sm:flex-row items-start px-4 justify-start gap-5 lg:pt-4'>
              {whyUsData.partnership.figures.map(figure => (
                  <Figure key={figure.id} image={figure.image} caption={figure.caption} />
              ))}
            </div>
          </div>
          <div className='grid grid-cols-2 gap-8 w-full lg:w-1/2 mt-4 lg:mt-0'>
