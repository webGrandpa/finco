...
const Hero = () => {
    ...
    return (
        <div className="relative w-full min-h-screen bg-img">
            ...
            <div className="relative w-full mt-14 px-6 md:px-10 lg:px-16 xl:px-40 py-10">
                <div className="max-w-[1440px] mx-auto flex flex-col md:gap-10 gap-6 items-start justify-center text-start lg:mt-30 md:mt-0">
