...
export const teamMembers = [
  { id: 1, 
    ...
    experience: "12+ წლიანი გამოცდილება საბანკო და საინვესტიციო სფეროში." },
  { id: 2, 
    image: '/avatar2.svg', 
    name: "ქეთი ქათამაძე", 
    title: "ფინანსური მრჩეველი", 
    experience: "კორპორაციული სამართლის სპეციალისტი 10+ წლიანი პრაქტიკით." },
  { id: 3, 
    image: '/avatar3.svg', 
    name: "თამუნა მუსერიძე", 
    title: "იურიდიული კონსულტანტი", 
    experience: "კორპორაციული სამართლის სპეციალისტი." },
  { id: 4, 
    image: '/avatar4.svg', 
    name: "ხატია შუშაძე", 
    title: "განვითარების მენეჯერი", 
    experience: "ექსპერტი სტარტაპებსა და ბიზნეს სტრატეგიებში." },
];